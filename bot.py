...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data in ("start", "bachelor"):
        ...
        await query.edit_message_text(
            ...
            "📌 <b>Паспорт та витяг з реєстру територіальної громади</b>\n"
            ...
            "📌 <b>Індивідуальний податковий номер (ІПН)</b>\n"
            ...
            "⚠️ Особи віком 25 років і старші приписку надавати не можуть!\n\n"
            ...
            "❗️ У разі розбіжності прізвища, імені або по батькові в документах — надати свідоцтво про шлюб, зміну імені тощо.\n\n"
