...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data in ("start", "bachelor"):
        ...
        await query.edit_message_text(
            "📝 <b>Коефіцієнти НМТ</b>\n\n"
            "Конкурсний бал залежить від:\n"
            "▫️ результатів НМТ (бали 100-200 з кожного предмета)\n"
            "▫️ коефіцієнтів конкретної спеціальності\n"
            "▫️ регіонального коефіцієнта <b>1,07</b> (для всіх вступників до ЗНУ)\n"
            "▫️ галузевого коефіцієнта <b>1,02</b> для пріоритетів 1-2 на спеціальності особливої підтримки\n"
            "▫️ балів за творчий конкурс (якщо потрібен)\n\n"
            "━━━━━━━━━━━━━━━\n\n"
