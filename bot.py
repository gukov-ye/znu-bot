...
FACULTIES = [
    ...
    ("hist",        "📜 Історії та міжнародних відносин",       "📜 Факультет історії та міжнародних відносин"),
    ("math",        "🔢 Математичний",                          "🔢 Математичний факультет"),
    ("journ",       "📰 Журналістики",                          "📰 Факультет журналістики"),
    ("foreign",     "🌍 Іноземної філології",                   "🌍 Факультет іноземної філології"),
    ("manag",       "💼 Менеджменту",                           "💼 Факультет менеджменту"),
    ("spp",         "🧠 Соціальної педагогіки та психології",   "🧠 Факультет соціальної педагогіки та психології"),
    ("socio",       "🏛 Соціології та управління",              "🏛 Факультет соціології та управління"),
    ("phys",        "⚽ Фізвиховання, здоров'я та туризму",     "⚽ Факультет фізичного виховання, здоров'я та туризму"),
    ("philol",      "📝 Філологічний",                          "📝 Філологічний факультет"),
    ("law",         "⚖️ Юридичний",                             "⚖️ Юридичний факультет"),
    ("eng",         "🏗 Інженерний інститут",                   "🏗 Інженерний навчально-науковий інститут ім. Ю.М. Потебні"),
...
FACULTY_SPECS = {
    "bio": (
        ...
        "▫️ A4 <b>Середня освіта (Біологія та здоров'я людини)</b>\n"
        "   📋 денна (є бюджет)\n"
    ...
    "hist": (
        ...
        "▫️ A4 <b>Середня освіта (Історія та громадянська освіта)</b>\n"
        "   📋 денна (є бюджет), заочна (є бюджет)\n"
        "   👤 Савченко Ірина Володимирівна — 097 241 42 24\n"
        "   <a href=\"https://www.znu.edu.ua/ukr/pk/4362/bakalavr/12329\">📄 Програма</a>\n\n"
        "▫️ A4 <b>Середня освіта (Географія)</b>\n"
        "   📋 денна (є бюджет), заочна (є бюджет)\n"
        "   👤 Савченко Ірина Володимирівна — 097 241 42 24\n"
    ...
    "foreign": (
        ...
        "▫️ A4 <b>Середня освіта (Мова і література (англійська))</b>\n"
        "   📋 денна (є бюджет), заочна (є бюджет)\n"
        ...
        "▫️ B11 <b>Німецька мова і література (переклад включно), англійська мова</b>\n"
        "   📋 денна (є бюджет)\n"
        ...
        "▫️ B11 <b>Французька мова і література (переклад включно), англійська мова</b>\n"
        "   📋 денна (є бюджет)\n"
    ...
    "manag": (
        ...
        "   <a href=\"https://www.znu.edu.ua/ukr/pk/4362/bakalavr/12383\">📄 Програма</a>\n\n"
        "▫️ D3 <b>Економіка та управління бізнесом (міждисциплінарна)</b>\n"
    ...
    "phys": (
        ...
        "▫️ A4 <b>Середня освіта (Фізична культура)</b>\n"
        "   📋 денна (є бюджет)\n"
    ...
    "philol": (
        ...
        "▫️ A4 <b>Середня освіта (Українська мова і література)</b>\n"
        "   📋 денна (є бюджет), заочна (є бюджет)\n"
...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data in ("start", "bachelor"):
        ...
        await query.edit_message_text(
            ...
            "🗓 Оскільки програма контрактна, подати заяву можна і в додатковий набір (до 18 вересня)\n\n"
            "💰 <b>Вартість навчання:</b> 26 019 грн/семестр\n"
            "Оплату можна розбити помісячно.\n\n"
            "📝 <b>Сертифікати НМТ для вступу:</b>\n"
            "▫️ Українська мова\n"
            "▫️ Математика\n"
            "▫️ Історія України\n"
            "▫️ Англійська мова\n\n"
            "📖 Більше про LAS та вступ на цю програму — <a href=\"https://www.instagram.com/p/Da8SV3GDcBC/\">за посиланням</a>\n\n"
        ...
        await query.edit_message_text(
            "🏠 <b>Гуртожиток ЗНУ — для першачків</b>\n\n"
            "Реєстрація на проживання для першокурсників бакалаврату, магістратури й тих, хто поселяється вперше:\n\n"
            "🔹 <b>5–16 серпня</b> — подати заяву\n"
            "Реєстрація: <a href=\"https://hostel.znu.edu.ua/register\">hostel.znu.edu.ua/register</a>\n"
            "Заяви — тільки в електронному вигляді, дані вносити українською згідно з паспортом\n\n"
            "🔹 <b>25–26 серпня</b> — отримати направлення\n"
            "На пошту, вказану при реєстрації, надійде направлення з номером гуртожитку та кімнати — його треба роздрукувати для поселення\n\n"
            "🔹 <b>27–28 серпня</b> — поселення\n"
            "9:30–12:00 та 13:00–15:00\n\n"
            "💰 <b>Вартість:</b> 8 000 грн за 10 місяців (оплата — до дня поселення)\n\n"
            "🛡️ <b>Пільгова оплата:</b>\n"
            "▪️ безоплатно — діти-сироти та діти, позбавлені батьківського піклування; учасники бойових дій та діти УБД\n"
            "▪️ 4 000 грн (50%) — внутрішньо переміщені особи\n\n"
            "☎️ (061) 228-76-48\n"
            "📧 <a href=\"mailto:gurt03@ukr.net\">gurt03@ukr.net</a>\n\n"
            "📎 <a href=\"https://sites.znu.edu.ua/liberal_edu/studmisto/156.ukr.html\">Перелік документів і деталі поселення</a>",
            reply_markup=back_menu("other"), parse_mode="HTML", disable_web_page_preview=True
        )
        ...
        await query.edit_message_text(
            "📝 <b>Коефіцієнти НМТ</b>\n\n"
            "Конкурсний бал залежить від того:\n"
            "- який бал ти склав НМТ\n"
            "- на яку спеціальність вступаєш\n"
            "- чи має ця спеціальність особливу підтримку\n\n"
            "📚 <b>Як це працює?</b>\n\n"
            "Кожен предмет НМТ множиться на свій коефіцієнт. Цей коефіцієнт <b>залежить від спеціальності</b> — наприклад, для філологів важливіша мова, для математиків — математика.\n\n"
            "Далі додаються бонуси:\n"
            "🏛 <b>Регіональний коефіцієнт</b> 1,07 — для всіх, хто вступає до ЗНУ\n"
            "🎯 <b>Галузевий коефіцієнт</b> 1,02 — якщо ти подаєш заяву з 1 або 2 пріоритетом на спеціальність з особливою підтримкою\n"
            "🎨 <b>Творчий конкурс</b> — для дизайну, мистецтва, спорту та архітектури\n"
            "🎓 <b>Підготовчі курси</b> — бонус до 10 балів, якщо ти їх закінчив у ЗНУ\n\n"
            "🧮 <a href=\"https://znucalc.netlify.app\">Калькулятор конкурсного балу</a>\n\n"
            "Вкажи свої бали НМТ та спеціальність — отримай готовий розрахунок.\n\n"
            "📊 <b>Підсумок:</b>\n\n"
            "Усі деталі — у Додатку 7 до Правил прийому. Там для кожної спеціальності є точні коефіцієнти.\n\n"
            "📄 <a href=\"https://pk.znu.edu.ua/2026/pp2026/dodatok_7_do_pp_perel__k_predmet__v_nmt.pdf\">Перелік коефіцієнтів — Додаток 7</a>",
            reply_markup=back_menu("bach_questions"), parse_mode="HTML",
            disable_web_page_preview=True
        )
        ...
        await query.edit_message_text(
            "📑 <b>Як вступникам підтвердити пільги?</b>\n\n"
            "Ознайомитись з переліком пільг та необхідними документами можна <a href=\"https://pk.znu.edu.ua/2026/katehorii_spetsialnykh_umov_vstupu_ta_dokumenty_dlia_yikh_pidtverdzhennia_vo_202.pdf\">за посиланням</a>.\n\n"
            "<b>Що потрібно зробити:</b>\n\n"
            "1. Зареєструвати електронний кабінет\n\n"
            "2. Подати підтверджуючі документи:\n"
            "▫️ особисто до приймальної комісії (навч. корпус 2, каб. 116)\n"
            "▫️ дистанційно — через <a href=\"https://forms.gle/KSgvjvdZ45M2ChL66\">Google-форму</a>\n\n"
            "📄 <a href=\"https://pk.znu.edu.ua/4488.ukr.html\">Більше для пільгових категорій</a>",
            reply_markup=back_menu("bach_questions"), parse_mode="HTML", disable_web_page_preview=True
        )
        ...
        await query.edit_message_text(
            ...
            "Вартість навчання залежить від спеціальності та форми навчання. Ціни вказано за <b>один семестр</b>.\n\n"
            "Актуальні ціни на 2026 рік для всіх бакалаврських програм — на офіційній сторінці Приймальної комісії:\n\n"
            "📄 <a href=\"https://pk.znu.edu.ua/4917.ukr.html\">Вартість навчання — Бакалаврат 2026</a>",
            reply_markup=back_menu("bach_questions"), parse_mode="HTML", disable_web_page_preview=True
        )
        ...
        await query.edit_message_text(
            ...
            "🟢 <b>140 балів з 2-х предметів</b> → Грант І рівня <b>18 500 грн/рік</b>\n"
            "Для спеціальностей з особливою підтримкою.\n\n"
            "🟢 <b>150 балів з 2-х предметів</b> → Грант І рівня <b>18 500 грн/рік</b>\n"
            "Для будь-яких спеціальностей (окрім винятків нижче).\n\n"
            "🟡 <b>170 балів з 2-х предметів</b> → Грант ІІ рівня <b>27 000 грн/рік</b>\n"
            "Для будь-яких спеціальностей. Максимальний рівень фінансування.\n\n"
            "📈 <b>Підвищувальні коефіцієнти:</b>\n"
            "▪️ <b>×1,5</b> — для випускників шкіл Запорізької, Миколаївської, Сумської та Харківської областей, які вступають до вишу <b>своєї ж області</b> (тобто діє для ЗНУ!)\n"
            "▪️ <b>×1,3–1,5</b> — для пріоритетних спеціальностей (освіта, інженерія, ІТ, охорона здоров'я, аграрні науки тощо)\n\n"
            "🚫 Грант І рівня <b>не діє</b> для економіки, журналістики, туризму та деяких філологічних спеціальностей.\n\n"
        ...
        await query.edit_message_text(
            ...
            "<b>4. Сертифікат та результати НМТ</b>\n"
            "Результати 2026/2025/2024/2023 років, сформовані в особистому кабінеті учасника НМТ.\n\n"
            "<b>5. Військово-обліковий документ з Резерв+ у роздрукованому вигляді</b>\n\n"
            "——————————————\n"
