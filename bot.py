...
SECTORS = [
    ("edu", "🎓 Освіта і педагогіка"),
    ("art", "🎭 Мистецтво та гуманітарні"),
    ("social", "📰 Соціальні науки та журналістика"),
    ("business", "💼 Бізнес, управління, право"),
    ("science", "🔬 Природничі науки і математика"),
    ("it", "💻 IT та кібербезпека"),
    ("engineering", "🏗 Інженерія і будівництво"),
    ("agro", "🌾 Сільське та лісове господарство"),
    ("health", "🩺 Здоров'я та соціальна сфера"),
    ("services", "🏨 Сфера послуг та туризм"),
    ("security", "🛡 Безпека"),
]

SECTOR_SPECS = {
    "edu": (
        "🎓 <b>Освіта і педагогіка</b>\n\n"
    ...
    "art": (
        "🎭 <b>Мистецтво та гуманітарні науки</b>\n\n"
        "Бакалаврські програми:\n\n"
    ...
    "agro": (
        "🌾 <b>Сільське та лісове господарство</b>\n\n"
        "Бакалаврські програми:\n\n"
...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data == "start":
        ...
        await query.edit_message_text(
            spec_text,
            reply_markup=back_menu("spec_bachelor"), parse_mode="HTML"
        )
